...
namespace ArnoldVinkStyles
{
    public partial class AVColors
    {
        ...
        public static SolidColorBrush AdjustColorBrightness(SolidColorBrush solidColorBrush, double brightness)
        {
            try
            {
                Color adjustedColor = Color.FromArgb(solidColorBrush.Color.A, (byte)(solidColorBrush.Color.R * brightness), (byte)(solidColorBrush.Color.G * brightness), (byte)(solidColorBrush.Color.B * brightness));
